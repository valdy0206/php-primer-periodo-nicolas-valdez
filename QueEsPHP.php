    ...
    <section class="contenedor todo-php">
            ...
            <img src="imagenes/web (1).png" width="40%" height="20%" alt="" class="imagen-concepto-php">
                <div class="contenido-textos">
                    ...
                    <p>PHP es un famoso lenguaje de programacion enfocado especialmente en el diseño y programacion de paginas web, es un lenguaje de codigo abierto</p>
                    <br>
                    </p>
                </div>
            </div>
            ...
            <div class="contenedor">
                ...
                <div class="galeria-port">
                    <div class="imagen-port">
                        <center><a href="#"><img src="imagenes/request.png" alt="">
