...
<head>
    ...
    <title>¿Es relevante en el desarrollo web? - PHP</title>
...
<body>
    <header>
        ...
        <section class="textos-header">
            <h1>¿Es relevante en el desarrollo web?</h1>
            <h2>investigación</h2>
        </section>
        ...
        <section class="contenedor todo-php">
            ...
            <div class="contenedor-todo-php">
                ...
                <div class="contenido-textos">
                    <h3><span>1</span>¿Es relevante en el desarrollo web?</h3>
                    <p>PHP es relevante porque nos facilita las conexiones a las bases de datos, esto les ofrece a los desarrolladores más libertad al escoger que tipo de base de datos se va a usar.</p>
                    <br>
                    </p>
                </div>
            </div>
        ...
        <section class="portafolio">
            <div class="contenedor">
                ...
                <div class="galeria-port">
                    ...
                    <div class="imagen-port">
                        <center><a href="#"><img src="imagenes/app.png" alt="">
                        <div class="hover-galeria">
                            <img src="imagenes/tap.png" alt="">
