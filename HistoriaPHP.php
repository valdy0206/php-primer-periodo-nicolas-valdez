        ...
        <section class="contenedor todo-php">
            ...
            <img src="imagenes/web (1).png" width="40%" height="20%" alt="" class="imagen-concepto-php">
                <div class="contenido-textos">
                    ...
                    <p>PHP surgió como una modificación a un lenguaje ya existente, este lengiaje era Perl, la modificación fue escrita por Rasmus Lendorf, un groenlandés, un Ingeniero en Diseño de Sistemas Informáticos en la Universidad de Waterloo.La modificación a este lenguaje lo hizo para comprobar quién accedía a su curriculum en su web.</p>
                    <br>
                    </p>
                </div>
            </div>
